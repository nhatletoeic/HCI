...
<div class="input-field col m6 s12">
<select  name="employee" autocomplete="off">
...
foreach($results as $result)
{   ?>                                            
<option value="<?php echo htmlentities($result->LastName);?>"><?php echo htmlentities($result->LastName);?></option>
<?php }} ?>
</select>
</div>                                             
