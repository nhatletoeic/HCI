  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Change Password</a></li>
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="apply-leave.php">Apply Task</a></li>
                                <li><a href="leavehistory.php">Task History</a></li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="footer">
                    <p class="copyright"><a href="http://www.code-projects.org/">HCI-LTU14 </a> Vũ Nhật Lệ</p>
