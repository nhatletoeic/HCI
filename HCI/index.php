...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>HCI-LTU14 | Home Page</title>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">ELMS | Task Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="">HCI-LTU14 </a> Vũ Nhật Lệ</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Task Management System</h4></div>
